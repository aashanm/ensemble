...
tier_1_frequencies = [145, 150, 160, 220, 225, 255, 320, 450, 535]
tier_2_frequencies = [625, 735, 825, 1100, 1350, 1380, 1440, 1600, 1750]
tier_3_frequencies = [2200, 2230, 2310, 2530, 2830, 3090, 3110, 3200, 3320]
tier_4_frequencies = [3620, 3630, 3790, 4130, 4450, 4540, 4640, 4820, 4860]
volume = 2
...
while True:
    ...
    if line:
        ...
        frequencies_to_play.append([random.choice(tier_1_frequencies)] * num_beat_repetitions)
